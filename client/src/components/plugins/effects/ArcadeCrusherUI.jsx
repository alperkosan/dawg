...
// Removed custom CrusherModeSelector - now using standard ModeSelector component
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-black via-neutral-950 to-black p-3 flex gap-3">
      ...
      <div className="w-[220px] flex-shrink-0 flex flex-col gap-4">
        ...
        {/* Plugin Header */}
        <div className="bg-gradient-to-r from-orange-900/40 to-red-900/40 rounded-xl px-4 py-3 border border-orange-500/30">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-[9px] text-red-400/70">The Texture Lab</div>
            </div>
          </div>
        </div>
        ...
        {/* Mode Selector */}
        <ModeSelector
          modes={Object.values(CRUSHER_MODES).map(mode => ({
            id: mode.id,
            label: mode.name,
            icon: mode.icon,
        ...
        <div className="bg-gradient-to-br from-orange-900/20 to-black/50 rounded-xl p-4 border border-orange-500/10">
          ...
          <div className="text-[10px] text-white/70 leading-relaxed">
            {CRUSHER_MODES[currentMode].description}
          </div>
        </div>

        {/* Category Badge */}
        <div className="mt-auto bg-gradient-to-r from-orange-900/40 to-red-900/40 rounded-lg px-3 py-2 border border-orange-500/20 text-center">
          <div className="text-[8px] text-red-400/50 uppercase tracking-wider">Category</div>
