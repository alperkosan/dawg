...
function PianoRoll({ instrument, audioEngineRef, pattern, onPatternChange, playbackState }) {
    ...
    const gridDimensions = useMemo(() => ({
        ...
        gridHeight: 96 * 20 * zoomY // 8 octave
    }), [zoomX, zoomY, loopLength]);

    // Koordinat converter
    const converter = useMemo(() => 
        new CoordinateConverter(
        gridDimensions.stepWidth, 
        gridDimensions.keyHeight, 
        KEYBOARD_WIDTH
        ), 
        [gridDimensions.stepWidth, gridDimensions.keyHeight]
    );
                    ...
                    >
                        ...
                        >
                            <PianoRollGrid
                                ...
                                noteToY={converter.pitchToY.bind(converter)}
                                stepToX={converter.stepToX.bind(converter)}
                                keyHeight={gridDimensions.keyHeight} 
                                stepWidth={gridDimensions.stepWidth}
