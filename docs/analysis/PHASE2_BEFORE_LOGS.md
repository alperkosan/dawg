...
**Tarih:** [Test tarihini buraya yazın]  
**BPM:** [Test BPM'i, örn: 160]  
**Pattern:** [Pattern detayları, örn: 4 enstrüman, 150 nota, 64 step]

---

## Senaryo 1: Event Count Scalability (BEFORE)
...
**Notlar:**
- [Ek gözlemlerinizi buraya yazın]

---

## Senaryo 2: Event Batching (BEFORE)
...
## Senaryo 3: Automation Smoothness (BEFORE)
...
[Test sırasında fark ettiğiniz diğer durumları buraya yazın]
