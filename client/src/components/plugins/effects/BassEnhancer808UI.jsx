...
// Removed custom BassModeSelector - now using standard ModeSelector component
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-black via-neutral-950 to-black p-3 flex gap-3">
      ...
      <div className="w-[220px] flex-shrink-0 flex flex-col gap-4">
        ...
        <div className="bg-gradient-to-r from-blue-900/40 to-indigo-900/40 rounded-xl px-4 py-3 border border-blue-500/30">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="text-sm font-black text-blue-300 tracking-wider uppercase">
                808 Bass Enhancer
              </div>
              <div className="text-[9px] text-indigo-400/70">The Dynamics Forge</div>
            </div>
          </div>
        </div>
        ...
        {/* Category Badge */}
        <div className="mt-auto bg-gradient-to-r from-blue-900/40 to-indigo-900/40 rounded-lg px-3 py-2 border border-blue-500/20 text-center">
          <div className="text-[8px] text-indigo-400/50 uppercase tracking-wider">Category</div>
          <div className="text-[10px] text-blue-300 font-bold">Dynamics Forge</div>
        </div>
      </div>
