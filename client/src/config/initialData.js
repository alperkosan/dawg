...
const createMixerTracks = () => {
  ...
  { id: 'track-2', name: 'Snare', type: MIXER_TRACK_TYPES.TRACK, volume: -3.5, pan: 0, color: '#C85A54', output: 'bus-3', insertEffects: [], sends: [] },
  { id: 'track-3', name: 'Clap', type: MIXER_TRACK_TYPES.TRACK, volume: -4, pan: 0, color: '#C85A54', output: 'bus-3', insertEffects: [], sends: [] },
  { id: 'track-4', name: 'Hi-Hat', type: MIXER_TRACK_TYPES.TRACK, volume: -10, pan: -0.15, color: '#D4A259', output: 'bus-3', insertEffects: [], sends: [], inputGain: 0, eq: { highGain: 0, highFreq: 12000, midGain: 0, midFreq: 2500, midQ: 1, lowGain: 0, lowFreq: 80 } },
  { id: 'track-5', name: 'Offbeat Hat', type: MIXER_TRACK_TYPES.TRACK, volume: -12, pan: 0.10, color: '#D4A259', output: 'bus-3', insertEffects: [], sends: [], inputGain: 0, eq: { highGain: 0, highFreq: 12000, midGain: 0, midFreq: 2500, midQ: 1, lowGain: 0, lowFreq: 80 } },
  ...
  { id: 'track-9', name: 'Glide Synth', type: MIXER_TRACK_TYPES.TRACK, volume: -10, pan: 0, color: '#B67BA3', insertEffects: [], sends: [] },
  { id: 'track-10', name: 'Scream Synth', type: MIXER_TRACK_TYPES.TRACK, volume: -11, pan: 0, color: '#B67BA3', insertEffects: [], sends: [] },
  { id: 'track-11', name: 'Vocal Chop', type: MIXER_TRACK_TYPES.TRACK, volume: -9, pan: 0, color: '#B67BA3', insertEffects: [], sends: [] },
  { id: 'track-12', name: 'Chord Stab', type: MIXER_TRACK_TYPES.TRACK, volume: -8, pan: 0, color: '#6B8EBF', insertEffects: [], sends: [] },
  { id: 'track-13', name: 'Sparkle Arp', type: MIXER_TRACK_TYPES.TRACK, volume: -12, pan: 0, color: '#6B8EBF', insertEffects: [], sends: [] },
  { id: 'track-14', name: 'Bell Chord', type: MIXER_TRACK_TYPES.TRACK, volume: -14, pan: 0, color: '#5A9B82', insertEffects: [], sends: [] },
  { id: 'track-15', name: 'Retro Synth', type: MIXER_TRACK_TYPES.TRACK, volume: -10, pan: 0, color: '#5A9B82', insertEffects: [], sends: [] },
